        ...
        <Container maxWidth="lg">
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Cup Agency is a dynamic and forward-thinking digital solutions
                provider. We are a passionate team of strategists, designers,
                developers, and marketers dedicated to helping businesses thrive
              ...
              <Typography
                ...
                fontFamily={"Poppins, sans-serif"}
              >
                Founded on the principles of creativity and technological
                expertise, we partner with clients of all sizes, from startups
                to established enterprises, to deliver impactful results.
              </Typography>
            </Grid>
          </Grid>
        </Container>
          ...
          >
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                tailored digital solutions that drive growth, enhance brand
                presence, and create lasting value. We aim to be a trusted
                partner, guiding our clients through the complexities of the
                digital landscape with clarity and expertise.
              </Typography>
              <Typography
                variant="body1"
                paragraph
              ...
              >
                ...
                understanding your unique goals to deliver strategies that truly
                resonate with your audience and achieve measurable success.
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              <SectionImage
      ...
      >
        <Container maxWidth="md">
          <Typography
            ...
            component="h2"
            gutterBottom
            sx={{ fontWeight: "650", fontFamily: "Poppins, sans-serif", mb: 2 }}
          >
          ...
          <CustomButton
            text="Contact Us"
            onClick={() =>
              (window.location.href = "mailto: nguyenthiminhminh.hcm@gmail.com")
            }
            sx={{
