...
export const DialogContent: React.FC = () => {
    ...
    useEffect(() => {
        if (!checkValidGenerate(viewState, deviceFile, videoUrl, MLVTVideo) || !sourceLanguage) {
    ...
    const handleGenerate = useCallback(async () => {
        ...
        try {
            ...
            const videoPromise = handleViewGenerate ? handleViewGenerate() : Promise.resolve(undefined);
