...
export const TextTranslationContent: React.FC<ContentProps> = ({
  ...
  const [originalTextContent, setOriginalTextContent] = useState<string | null>(
    null
  );
  const [resultTextInformation, setResultTextInformation] =
    useState<Text | null>(null);
            ...
            childrenData={[
              {
                ...
                props: {
                  ...
                  displayText: originalTextContent ? originalTextContent : "",
                },
              },
            ]}
          />
