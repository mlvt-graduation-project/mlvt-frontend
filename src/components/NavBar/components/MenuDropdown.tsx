...
import { AccountCircle, DarkMode, Help, LightMode, Logout, WorkspacePremiumSharp } from "@mui/icons-material";
import { Avatar, Box, Divider, ListItemIcon, ListItemText, Menu, MenuItem, Typography, useTheme } from "@mui/material";
...
const MenuDropdown: React.FC<MenuDropdownProps> = ({
    ...
    const handleMenuItemClick = (e: React.MouseEvent<HTMLElement>, item: typeof menuItems[0]) => {
        ...
        <>
            ...
            >
                {appearanceOptions.map(opt => (
                    <MenuItem key={opt.label} onClick={() => handleAppearanceSelect(opt)} sx={{
                        padding: '0.5rem 1rem',
                        gap: '1.2rem',
                        borderRadius: '0.4em',
                        '&:hover': {
