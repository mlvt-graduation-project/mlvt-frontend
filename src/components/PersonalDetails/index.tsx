...
const PersonalDetails: React.FC<UserDetails> = ({ user }) => {
  ...
  const uploadAvatar = async (file: File) => {
    try {
      const responseGeneratePresignedImageUpload = await getPresignedImageURL(
        file.name,
        file.type
      );
