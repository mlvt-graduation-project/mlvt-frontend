...
const SpeakerProfile: React.FC<SpeakerProfileProps> = ({
    ...
    return (
        <Box sx={{ position: 'relative', width: {xs: 120, sm: 150}, height: {xs: 120, sm: 150}, margin: 'auto' }}>
            <Avatar
                src={imageUrl}
                alt={altText}
                sx={{
            ...
            <Avatar
                ...
                border: (theme) => `3px solid ${theme.palette.background.paper}`, // Border matching background
